<div class="span3 sidebar">
	<?php include_once('blurb.php'); ?>
	<ul class="link-menu hidden-phone">
		<li class="yellow"><a href="https://twitter.com/ekrubnivek"><div class="genericon genericon-twitter"></div>Twitter</a>
		<li class="purple"><a href="https://github.com/kevinburke"><div class="genericon genericon-github"></div>Github</a>
		<li class="orange"><a href="http://feeds.feedburner.com/kburke"><div class="genericon genericon-feed"></div>Subscribe</a>
