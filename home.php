...
<div id="home" class="row">
	<div class="span6">
	<div id="top-posts" class="accordion">
		<h3 class="accordion-heading toggle">
	...
	<div id="start-here" class="accordion">
		<h3 class="accordion-heading toggle">
  ...
  <ul id="twitter" class="accordion">
	...
	<div id="recent-posts" class="accordion">
		<h3 class="accordion-heading toggle">
